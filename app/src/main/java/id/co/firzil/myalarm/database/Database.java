package id.co.firzil.myalarm.database;
...
public class Database extends SQLiteOpenHelper {
    ...
    public static final String COLUMN_SHAKE_VALUE = "alarm_shake";
    ...
    public static long create(Alarm alarm) {
        ...
        cv.put(COLUMN_SHAKE_VALUE,alarm.getValue());
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS " + ALARM_TABLE + " ( "
                ...
                + COLUMN_SHAKE_VALUE + " INTEGER NOT NULL)");
    }

...
import id.co.firzil.myalarm.preferences.AlarmPreferencesActivity;
...
public class MainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mathAlarmListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View v, int position, long id) {
                ...
                Intent intent = new Intent(MainActivity.this, AlarmPreferencesActivity.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent newAlarmIntent = new Intent(MainActivity.this, AlarmPreferencesActivity.class);
    ...
    public void updateAlarmList(){
        ...
        runOnUiThread(new Runnable() {
            public void run() {
                // reload content
                Log.d("tag", "onResumeiiiiiiiiiiiiiiiiii: "+alarms.size());
